		...
		try {
...

			{
				...
				PreparedStatement ps = con.prepareStatement(
						"CREATE TABLE  NEWACCOUNT(ACCOUNTNO int NOT NULL AUTO_INCREMENT ,USERNAME varchar(255),PASSWORD varchar(255),REPASSWORD varchar(255),AMOUNT int,ADDERESS varchar(255),PHONE int,PRIMARY KEY (ACCOUNTNO))");
				ps.executeUpdate();
